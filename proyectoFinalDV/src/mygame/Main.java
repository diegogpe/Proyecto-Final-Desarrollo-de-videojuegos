...
public class Main extends SimpleApplication {
    //public static final Quaternion PITCH090 = new Quaternion().fromAngleAxis(FastMath.PI/2,new Vector3f(0,0,0));
    ...
    public void simpleInitApp() {
        ...
        c.scale(4);
        c.setLocalTranslation(settings
                .getWidth()/2,settings.getHeight()/2,0);
    ...
    public void Enemigos(float tpf){
       ...
       // Vector3f prueba = CEO.getWorldTranslation();
    ...
    public void Perdiste(){
        ...
        //rootNode.detachChildNamed("GEnemigos");
    }
